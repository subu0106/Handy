...
const { 
  registerProvider, 
  updateProvider, 
  updateProviderServices, // Make sure this is imported
...
router.route("/updateProviderServices/:user_id").put(authenticateToken, updateProviderServices); // Add this line
